        ...
        <div class="container">
                    ...
                    <div class="footer-widget mb-30 ml-75">
                        ...
                        <div class="footer-list">
                            <ul>
                                ...
                                <li><a href="https://www.instagram.com/arenterprisesvapi/" target="_blank">Instagram</a></li>
            ...
            <div class="row">
                <div class="col text-center">
                    <p> &#169; {{ new Date().getFullYear() }} <a href="#" target="_blank">A R Enterprises Vapi.</a> All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
